...
export const WallpaperIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M21.5 2.5a2 2 0 0 0-2-2H4.5a2 2 0 0 0-2 2v19a2 2 0 0 0 2 2h15a2 2 0 0 0 2-2zM6.5 2.5v19M17.5 2.5v19M2.5 6.5h19M2.5 17.5h19" />
  </svg>
);
